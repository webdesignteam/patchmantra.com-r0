...
define('GoogleSite', 'True'); //True or False
define('GoogleSiteKey', 'True'); //VujoFQXatE0tscBRj-ctfZjB_MS8m9tIkAcmf4HuaB0
define('GoogleAnalytics', 'True'); //True or False
define('GoogleAnalyticsKey', 'GTM-TWTR3FX4'); //UA-98598831-1
