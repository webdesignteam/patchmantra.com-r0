			...
			<div class="row">
				<div class="col-md-12 healthcare_content_sec">
					<div class="healthcare_content">
					    <h6 class="healthcare_title">Patient Information</h6>	
						<h1 class="healthcare_sub_title">Understanding ReMASH™ for Your Liver Health</h1>					
					...
					<div >
						<p>If you've been diagnosed with MASH, ReMASH™ may be the first step toward taking back control of your liver health.</p>
					</div>					
				</div>				
			</div>
		</div>
