			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<div class="">
						...
						<img loading="eager" class="mb_display"
							src="<?php echo base_url();?>/assets/img/mobile.png?Version=<?php echo Version; ?>"
							...
							<div class="container-fluid">
								<div class="row banner_details_sec">
									<div class="col-md-6 banner_details">
										...
										<p class="banner_text">Smarter, gentler healing with science-backed transdermal
											patch therapy.</p>
									...
									<div class="col-md-6">
										<img loading="eager"
											src="<?php echo base_url();?>/assets/img/banner_side_image.png?Version=<?php echo Version; ?>"
			...
			<div class="row">
				<div class="col-md-6">
					<div class="about_img_sec">
						<img loading="eager"
							src="<?php echo base_url();?>assets/img/about_img.png?Version=<?php echo Version; ?>"
							alt="About Us">
					</div>
				</div>
				<div class="col-md-6 about_content_sec">
					<div class="about_content">
						...
						<p class="about_text">At Hetero Healthcare Limited, through the initiative Patch Mantra, we are
							committed to redefining the future of healthcare by shifting from traditional pill-based
							treatments to smarter, transdermal patch therapies. By combining scientific innovation,
							patient-first design, and digital tools like MantraBot, we make healing more intuitive,
							discreet, and empowering for better way to live and heal across India.</p>
						<div class="buy_now_section">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-5">
					<div class="why_patch_img_sec">
						<img loading="eager"
							src="<?php echo base_url();?>assets/img/why_patch_img.png?Version=<?php echo Version; ?>"
							alt="why_patch_img">
					</div>
				</div>
			</div>
			<div class="row why_transdermal">
				<div class="col-md-5">
					<div class="why_patch_img_sec">
						<img loading="eager"
							src="<?php echo base_url();?>assets/img/why_transdermal.png?Version=<?php echo Version; ?>"
							alt="why_transdermal">
					</div>
				</div>
				<div class="col-md-1"></div>
		...
		<div class="container">
			...
			<div class="owl-carousel product_carousel">
				<a href="<?php echo base_url();?>">
					<div class="product_card">
						<div class="product_img">
							<img src="<?php echo base_url();?>assets/img/product_img1.png?Version=<?php echo Version; ?>"
								alt="Nitof">
						</div>
				...
				<a href="<?php echo base_url();?>">
					<div class="product_card">
						<div class="product_img">
							<img src="<?php echo base_url();?>assets/img/product_img2.png?Version=<?php echo Version; ?>"
								alt="Nitof">
						</div>
						<div class="product_body">
				...
				<a href="<?php echo base_url();?>">
					<div class="product_card">
						<div class="product_img">
							<img src="<?php echo base_url();?>assets/img/product_img3.png?Version=<?php echo Version; ?>"
								alt="Nitof">
						</div>
						<div class="product_body">
				...
				<a href="<?php echo base_url();?>">
					<div class="product_card">
						<div class="product_img">
							<img src="<?php echo base_url();?>assets/img/product_img4.png?Version=<?php echo Version; ?>"
								alt="Nitof">
						</div>
						<div class="product_body">
	...
	<section class="moreblog_section">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12">
					<div class="buy_now_section">
						<a class="primary_btn" href="<?php echo base_url();?>why-patches">More Blogs</a>
					</div>
				</div>
			</div>
		</div>
